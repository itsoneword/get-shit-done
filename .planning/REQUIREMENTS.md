...
- [ ] **GRAPH-05**: `gsd-tools graph blast-radius <node>` returns the transitive `affects`/`provides` closure at a requested depth — level 1 (direct), level 2 (one-hop), level 3 (full closure)
