...
- This section feeds directly into /gsd2:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /gsd2:plan-phase --gaps with root causes
...
**Creation:** When /gsd2:verify-work starts new session
...
- `/gsd2:verify-work {phase}` picks up from first pending/blocked test
