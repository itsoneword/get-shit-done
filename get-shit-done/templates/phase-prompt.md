...
**Wave is pre-computed:** Wave numbers are assigned during `/gsd2:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
