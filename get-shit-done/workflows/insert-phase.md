...
Example: `/gsd2:insert-phase 72 Fix critical auth bug`
-> after = 72
...
Usage: /gsd2:insert-phase <after> <description>
Example: /gsd2:insert-phase 72 Fix critical auth bug
```
...
- Don't use this for planned work at end of milestone (use /gsd2:add-phase)
- Don't insert before Phase 1 (decimal 0.1 makes no sense)
- Don't renumber existing phases
- Don't modify the target phase content
- Don't create plans yet (that's /gsd2:plan-phase)
