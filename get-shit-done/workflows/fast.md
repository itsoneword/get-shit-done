...
Use /gsd2:quick for anything that needs multi-step planning or research.
</purpose>
...
```
This looks like it needs planning. Use /gsd2:quick instead:
  /gsd2:quick "{task description}"
```
...
- If the task takes more than 3 file edits, STOP and redirect to /gsd2:quick
- If you're unsure how to implement it, STOP and redirect to /gsd2:quick
</guardrails>
