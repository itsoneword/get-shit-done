<purpose>
Create structured `.planning/HANDOFF.json` and `.continue-here.md` handoff files to preserve complete work state across sessions. The JSON provides machine-readable state for `/gsd2:resume-work`; the markdown provides human-readable context.
</purpose>
...
<step name="write">
**Write handoff to `${phase_dir}/.continue-here.md` (partition-aware; legacy fallback `.planning/phases/XX-name/.continue-here.md`):**
...
✓ Handoff created:
  ...
  - ${phase_dir}/.continue-here.md (human-readable; legacy fallback path .planning/phases/[XX-name]/.continue-here.md)
