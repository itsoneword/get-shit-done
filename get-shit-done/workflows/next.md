...
```
No GSD project detected. Run `/gsd2:new-project` to get started.
```
Exit.
</step>
...
→ Next action: `/gsd2:discuss-phase <first-phase>`
...
▶ **Next step:** `/gsd2:[command] [args]`
  [One-line explanation of why this is the next step]
```

Then immediately invoke the determined command via SlashCommand.
Do not ask for confirmation — the whole point of `/gsd2:next` is zero-friction advancement.
</step>
