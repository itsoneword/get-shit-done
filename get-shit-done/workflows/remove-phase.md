...
- Example: `/gsd2:remove-phase 17` → phase = 17
- Example: `/gsd2:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /gsd2:remove-phase <phase-number>
Example: /gsd2:remove-phase 17
```
...
To abandon current work, use /gsd2:pause-work instead.
```
...
Would you like to:
- `/gsd2:progress` — see updated roadmap status
