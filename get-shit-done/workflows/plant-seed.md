...
Seeds auto-surface during /gsd2:new-milestone when trigger conditions match the
...
This seed should be presented during `/gsd2:new-milestone` when the milestone
...
This seed will surface automatically when you run /gsd2:new-milestone
