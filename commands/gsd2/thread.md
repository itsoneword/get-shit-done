...
```
No threads found. Create one with: /gsd2:thread <description>
```
</mode_list>
...
6. Report:
   ...
   Resume anytime with: /gsd2:thread {slug}
   ```
</mode_create>
...
- Lighter weight than /gsd2:pause-work — no phase state, no plan context
- The value is in Context and Next Steps — a cold-start session can pick up immediately
- Threads can be promoted to phases or backlog items when they mature:
  /gsd2:add-phase or /gsd2:add-backlog with context from the thread
