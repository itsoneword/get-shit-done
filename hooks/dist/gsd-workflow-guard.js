...
// The warning nudges Claude to use /gsd2:quick or /gsd2:fast instead of
    ...
    const output = {
      hookSpecificOutput: {
        ...
        additionalContext: `⚠️ WORKFLOW ADVISORY: You're editing ${path.basename(filePath)} directly without a GSD command. ` +
          ...
          'Consider using /gsd2:fast for trivial fixes or /gsd2:quick for larger changes ' +
