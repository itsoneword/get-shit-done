...
// (no active /gsd2: command or Task subagent) and injects an advisory warning.
//
// This is a SOFT guard — it advises, not blocks. The edit still proceeds.
// The warning nudges Claude to use /gsd2:fix or a GSD command instead of
...
process.stdin.on('end', () => {
  ...
  try {
    ...
    // Check if we're inside a GSD workflow (Task subagent or /gsd2: command)
    ...
    const output = {
      hookSpecificOutput: {
        ...
        additionalContext: `⚠️ WORKFLOW ADVISORY: You're editing ${path.basename(filePath)} directly without a GSD command. ` +
          ...
          'Consider using /gsd2:fix for tracked fixes or a GSD command for larger changes ' +
